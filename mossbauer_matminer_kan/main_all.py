...
parser.add_argument('--grids', type=str, default='3,10', help='list of integers')# '3,10,20,50,100'
...
if __name__ == '__main__':
    ...
    # plt.clf()
    # model.saveckpt(f'mossbauer_model/_{args.steps}_model_ckpt_formula')
    print(model.suggest_symbolic(0, 0, 0))
    # 符号公式
